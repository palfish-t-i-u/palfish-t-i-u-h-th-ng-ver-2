...
| M1-08 | Nghiệm thu CK thật qua QR (tiền vào + auto `tien_ve`) | cancelled | 2026-05-20 23:50 | 2026-08-05 | PayOS deprecated → SePay |
| M1-09 | Xác nhận STK VietQR công ty với Giang | done | 2026-05-20 23:55 | 2026-08-05 | bank.ts đã config HN account (970422/1680011668899) |
...
| I-02 | CRM auto-activate sau thanh toán | done | 2026-05-20 18:00 | 2026-08-05 | `/crm/activate` endpoint live |
| I-03 | Metabase: dropdown gói học tự động | on_hold | 2026-05-20 18:00 | | Blocker: cần API Metabase (VPN + browser only) |
...
| A-08 | Sync Metabase 24h/lần → `nhan_su_sale` | on_hold | 2026-05-21 11:30 | | Blocker: cần API Metabase (hiện chỉ truy cập qua VPN + browser) |
| A-09 | Giải thích cấu trúc team cho Kem (dùng `team_hierarchy.md`) | cancelled | 2026-05-21 11:30 | 2026-08-05 | One-time process task tháng 5 |
| A-10 | Bám sát Kem khi code dashboard (QA cross-check nghiệp vụ) | cancelled | 2026-05-21 11:30 | 2026-08-05 | One-time process task tháng 5 |
| A-11 | Tiếp tục kết nối POS (chờ API key) | done | 2026-05-21 11:30 | 2026-08-05 | Gateway sync + card reconciliation live |
...
| M3-05 | Excel 3 file — format merged header như `Report/3 file thuế/` | cancelled | 2026-05-22 18:00 | 2026-08-05 | M3/M4 legacy unmounted → ActivationTab/InvoiceRequestTab |
| M34-01 | Smoke E2E: Tab1 → tiền về → M3 → M4 → mở 3 Excel | cancelled | 2026-05-22 12:00 | 2026-08-05 | M3/M4 legacy unmounted |
| M34-02 | Deploy M3/M4 prod (SQL + Render + Vercel) | cancelled | 2026-05-22 12:00 | 2026-08-05 | M3/M4 legacy unmounted |
...
| UX-04 | UI refresh theo `WIREFRAMES.md` / `DESIGN.md` (tab legacy) | cancelled | 2026-05-23 | 2026-08-05 | Stale — nhiều lần refactor đã thay thế |
| UX-05 | Đồng bộ doc `docs/` ver-2 | done | 2026-05-23 | 2026-05-26 | Cập nhật B1–B4 + encoding |
| UX-06 | Render: deploy BE payment-request routes prod | done | 2026-05-23 | 2026-08-05 | payment_request_routes.py live |
...
| UX-11 | Promote Vercel + smoke B1–B4 prod | done | 2026-05-26 | 2026-08-05 | ui/ux merged to main |
...
| UX-13 | `git push origin ui/ux` — đồng bộ remote + graph Git | done | 2026-05-26 21:45 | 2026-08-05 | Branch merged to main |
| UX-14 | Supabase: chạy `active_requests_nullable_pr.sql` (dev + prod nếu standalone AR) | done | 2026-05-26 21:45 | 2026-08-05 | AR system live |
| UX-15 | Smoke: standalone AR + export-batch B4 + cash pending B2 | done | 2026-05-26 21:45 | 2026-08-05 | All features live |
...
| UX-17 | BE: endpoint xóa/cancel Active Request cho nút X đỏ vuông | done | 2026-05-28 08:45 | 2026-08-05 | DELETE endpoint live |
| UX-18 | BE: persist `invoice_requested_at` trong `uids_data.courses[]` | done | 2026-05-28 08:45 | 2026-08-05 | Persisted in ActiveRequestPatchCoursePayload |
...
| M5-06 | Import lịch sử `HNxHCM GMV.xlsx` | cancelled | 2026-05-23 | 2026-08-05 | Data live từ SePay/CRM đã đủ |
| M5-07 | Cấu hình tỷ giá theo thời điểm (System) | done | 2026-05-23 | 2026-08-05 | exchange_rates table + API live |
| M5-09 | Promote Vercel sau push UI M5 (không chỉ preview) | done | 2026-05-23 | 2026-08-05 | M5 live on production |
| M5-12 | Doc đối chiếu GMV tab / DingTalk / thẻ Sổ | done | 2026-05-25 | 2026-05-25 | `docs/M5_DOI_CHIEU.md`; audit 25/05 |
| M5-13 | Re-seed Sổ từ DingTalk xlsx (purge gsheet) | cancelled | 2026-05-25 | 2026-08-05 | Sổ live data đủ, re-seed không cần |
| M5-14 | Xóa dòng M3 test (`tu_dong`) qua UI/API | done | 2026-05-25 | 2026-08-05 | DELETE /revenue/ledger/{row_id} live |
...
| B-03 | Dashboard Leader (GMV team) | done | 2026-05-21 17:00 | 2026-08-05 | BC01 + RBAC team scoping đã cover |
| B-04 | Verify domain Resend (tránh spam) | cancelled | 2026-05-21 17:00 | 2026-08-05 | Resend không còn dùng; Supabase Auth native |
...
| B-08 | Re-seed nhân sự VN (`seed_nhan_su_sale.py`) sau v3 | cancelled | 2026-05-21 22:00 | 2026-08-05 | Không ảnh hưởng vận hành |
...
|----|------|--------|-------|---------|
| F2605-P0-01 | Sửa lỗi dữ liệu **tất cả báo cáo** (~5% lệch thập phân/ngày) | cancelled | Minh | Data mới đã đúng; audit Sổ vs All File thực hiện sau |
| F2605-P0-02 | Xóa dòng M3 test khỏi Sổ prod | cancelled | Minh/Ops | API xóa đã có (M5-14); xóa qua UI nếu cần |
| F2605-P0-03 | Re-seed Sổ từ DingTalk xlsx (backup trước) | cancelled | Minh/Ops | = M5-13 cancelled |
| F2605-P0-04 | Rà chênh lệch báo cáo **tháng 1–2–3** | cancelled | Minh | Data cũ trước khi system live; audit Sổ vs All File thực hiện sau |

### Module đối chiếu bank (Giang / Đức)

| ID | Task | Status | Owner | Ghi chú |
|----|------|--------|-------|---------|
| F2605-BANK-01 | Module bank — kết nối biến động số dư | cancelled | Giang/Đức | Deprecated — đối soát GD hiện tại đã cover |
| F2605-BANK-02 | Logic so sánh tiền thật vs Sổ doanh thu | cancelled | Giang/Đức | Deprecated |
| F2605-BANK-03 | CK tay ngoài QR — thu qua email/parse số dư (dự kiến QL) | cancelled | Giang/Đức | Deprecated |

### Go-live tuần đầu

| ID | Task | Status | Owner | Ghi chú |
|----|------|--------|-------|---------|
| F2605-GOLIVE-01 | Hướng dẫn sử dụng cơ bản cho sale | cancelled | Hiếu | System live từ tháng 6; HDSD đã có |
| F2605-GOLIVE-02 | Thu feedback đội sale sau go-live | cancelled | Hiếu | Feedback đã thu qua nhiều đợt |

### Luồng thanh toán mới — backend (Giang / Đức)

| ID | Task | Status | Owner | Ghi chú |
|----|------|--------|-------|---------|
| F2605-BE-01 | Schema + API **Payment Request** (PR ID) | done | Giang/Đức | payment_request_routes.py fully live |
| F2605-BE-02 | Mã thanh toán lẻ / Info Code (vd. TTPR…) gắn PR | done | Giang/Đức | `payment-lines` + PayOS |
| F2605-BE-03 | **Course code** (B3) — mở khi PR thu đủ 100%; link xuất HĐ | done | Giang/Đức | activation_routes.py live |
| F2605-BE-04 | Module xác nhận **tiền mặt** | done | Giang/Đức | Cash/card `pending` @ `2f93684` |
| F2605-BE-05 | Tích hợp **thẻ tín dụng / trả góp** | done | Giang/Đức | Card/installment handling live |
| F2605-BE-06 | PayOS **PalFish Saigon** — chỉ team HCM tạo QR HCM | pending | Giang/Đức | Pháp nhân HCM riêng |
| F2605-BE-07 | Khớp **Order ID CRM** với Activate Code (matching) | done | Giang/Đức | Order ID matching in uids_data |
...
| F2605-MINH-06 | UX Sổ — auto dòng khi tiền về + Ops duyệt | done | 2026-05-26 | revenue_routes.py auto insert loai_nhap=tu_dong |
| F2605-MINH-07 | Đổi nhãn BC02 — không gọi Key Data đầy đủ | done | 2026-05-26 | Subtitle tiếng Việt đã có |
| F2605-MINH-08 | UX chọn tài khoản HN / HCM | done | 2026-05-26 | getAvailableBanks(team) filters HN/HCM |
| F2605-MINH-09 | Catalog tên sản phẩm HĐ (dropdown TTS) | pending | 2026-05-26 | `ke-hoach-cai-thien-feedback-thu-hien.md` |
| F2605-MINH-10 | Checklist UAT go-live với Giang & Đức | cancelled | 2026-05-26 | System live từ tháng 6 |
...
| ID | Task | Status | Owner | Ghi chú |
|----|------|--------|-------|---------|
| F2705-A2-01 | **F7** Format `qr.createdAt` → `formatPaymentDateFull` | done | Minh | Verified 2026-08-05 |
| F2705-A2-02 | **F6b** Add `"rejected"` branch vào `paymentAttemptLabel` | done | Minh | Verified 2026-08-05 |
| F2705-A2-03 | **F6c** Popup nhập lý do từ chối | done | Minh | RejectReasonModal in ReconciliationTab |
| F2705-A2-04 | **F6a** Optimistic reject | done | Minh | Optimistic update in PaymentFlowContext |
| F2705-A2-05 | **F4a** CSS fix `.qr-row.v2` grid | done | Minh | Grid rules updated |
| F2705-A2-06 | **F4b/c** Đổi label BillUploadZone | done | Minh | Labels updated |
| F2705-A2-07 | **F3** Bank dropdown alias | done | Minh | BANK_ACCOUNTS in bank.ts |
| F2705-A2-08 | **F2a** QR compact2 template | done | Minh | buildVietQrUrl compact2 |
| F2705-A2-09 | **F2b** Copy nội dung CK đầy đủ | done | Minh | buildFullBankText |
| F2705-A2-10 | **F2c** Copy QR PNG to clipboard | done | Minh | ClipboardItem API |
| F2705-A2-11 | **F5** Multi-bill upload | done | Minh+Giang/Đức | bill_images array support |

### Phase B — Cần BE mới làm được (Giang/Đức + Minh kết nối FE)

| ID | Task | Status | Owner | Ghi chú |
|----|------|--------|-------|---------|
| F2705-B-01 | `PATCH /api/v1/payment-requests/{id}` — lưu edit PR vào DB | done | Giang/Đức | Endpoint live |
| F2705-B-02 | `PATCH /api/v1/active-requests/{id}` + `info_confirmed_at` | done | Giang/Đức | Endpoint live |
| F2705-B-03 | ~~Multi-bill upload~~ — gộp vào A2-11 | done | Giang/Đức | bill_images array support |
| F2705-B-04 | Bank list alias: "PalFish Hà Nội - MB Bank" + HCM | done | Minh | BANK_ACCOUNTS in bank.ts HN+HCM |
| F2705-B-05 | `payment_lines.downloaded_at` — tracking B4 download thuế | done | Giang/Đức | invoiced_at + trạng thái "Đã xuất HĐ" cover 100% |
...
| F2705-C-03 | Inline AR create trong PR drawer (thay navigate tab riêng B3) | cancelled | Minh | Deprecated — AR tạo gắn liền báo đơn |

### Cần Hiếu xác nhận thêm

| ID | Task | Status | Owner | Ghi chú |
|----|------|--------|-------|---------|
| F2705-H-01 | Account HCM: tên alias + accountNo + BIN MB Bank | done | Hiếu | HCM config in bank.ts |
...
| F2705-BUG-02 | AR drawer: nút "Xác nhận thông tin" Thu Hiền + B4 disable trước confirm | done | Minh + Giang/Đức | info_confirmed_at handling live |
...
| F2705-T2-02 | BE lưu gói học từ PR drawer vào `active_requests.uids_data` | done | Đức | uids_data PATCH live |
...
| AUTH-06 | Siết CORS Vercel regex | done | Đạt | Regex pattern active in main.py |
| AUTH-07 | Bỏ query thừa 500 dòng | done | Đạt | Commit `d5530c7` |
| OTHER-01 | Verify PayOS webhook signature | done | Giang | Commit `6719438` |
| OTHER-02 | Trùng mã QR PayOS | cancelled | Giang | PayOS deprecated → SePay |
...
| VAC-03 | BE installment: validate `sale_received ≤ installment_total` | done | Đạt | 2026-06-30 | 2026-07-29 | `payment_request_routes.py:2731`; 8 pytest pass |
| VAC-04 | Merge sandbox → main (12 commits addr static JSON + handoff docs) | cancelled | Giang | 2026-06-30 | 2026-08-05 | Branch quá cũ, cherry-pick nếu cần rồi xóa |
| VAC-05 | Cleanup fallback 3700 BE (tỷ giá) | done | Đức | 2026-06-30 | 2026-07-29 | `get_rate_for_date()` in revenue_routes + dashboard_routes; 3700 giữ làm fallback khi chưa có row exchange_rates |
| VAC-06 | Cleanup fallback 3700 FE | done | Đạt | 2026-06-30 | 2026-07-29 | `Module6Tab.tsx:142-155` useEffect gọi `exchangeRates.list()`; 1 vitest pass |
