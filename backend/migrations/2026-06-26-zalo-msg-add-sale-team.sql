-- Migration: Bổ sung thông tin Team của Sale vào thông báo Zalo
-- Target: PRODUCTION
-- Date: 2026-06-26
-- Idempotent: CREATE OR REPLACE — an toàn chạy lại nhiều lần

-- 1. Cập nhật hàm build_payment_paid_message — thêm "· Team %s"
...
-- 2. Cập nhật hàm build_course_activated_message — thêm "· Team %s"
...
BEGIN
  ...
  RETURN format(
    '✅ ĐÃ KÍCH HOẠT THÀNH CÔNG GÓI HỌC — KH %s của %s · Team %s với gói %s',
