...
export const MODULE_LIST: ModuleDef[] = [
  ...
  { key: "payments", label: "Quản lý Doanh thu", description: "Nhập / sửa doanh thu, báo cáo tự sinh, đối soát nội bộ", section: "Báo cáo" },
...
export const DEFAULT_PERMISSIONS: Record<string, Record<string, AccessLevel>> = {
  ...
  hr: {
    ...
    revenueLedger: "full", payments: "full", bc01: "full", bc02: "full", bc03: "full",
  ...
  cs: {
    ...
    revenueLedger: "none", payments: "none", bc01: "none", bc02: "none", bc03: "none",
    module5: "none", module6: "none",
    authAccounts: "none", profile: "full",
  },
};
