...
4. Chọn cách gửi cho khách:
   ...
   - **Mở link PayOS** (nếu có) — mở trang thanh toán PayOS để khách tự thao tác.

## Sau khi gửi

- Khách chuyển khoản xong, hệ thống tự xác nhận (PayOS/SePai) hoặc kế toán ghép tay ở tab **Đối soát giao dịch**.
