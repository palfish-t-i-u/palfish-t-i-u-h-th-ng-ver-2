---
title: "Tổng quan tạo gói học (B3)"
order: 0
audience: ["sale"]
---
...
![Màn hình Tạo gói học: danh sách Active Request, trạng thái Order ID](/docs-images/module3/tong-quan-1.png)

## Khái niệm chính

- **Active Request (AR)** — 1 yêu cầu tạo gói học, chứa danh sách bé + gói học đã đăng ký cho 1 PR.
...
1. Sale bấm **Báo đơn & Tạo gói học** ở PR đã đủ tiền → AR được tạo tự động (xem bài **Báo đơn & Tạo gói học** ở Quản lý thanh toán).
2. Vào **Tạo gói học**, tìm đúng AR, điền **Order ID CRM** cho từng Course Code sau khi đã đăng ký khoá thật trên CRM.
