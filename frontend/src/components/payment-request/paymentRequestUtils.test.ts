...
describe("active request course package updates", () => {
  ...
  it("creates linked active request courses from received money, not target money", () => {
    ...
    const payload = buildCreateActiveRequestPayload(pr, [
      { childName: "", uid: pr.uid, phone: "", phoneCountry: "VN", packageName: "2/W-NEW 24 PHI+2 HN", amount: pr.received, leadSource: "", leadChannel: "" },
    ]);
  ...
  it("2 bé → 2 uid block, mỗi block mang name bé (modal AR mở rộng)", () => {
    ...
    const payload = buildCreateActiveRequestPayload(pr, [
      { childName: "Bé Một", uid: "u1", phone: "", phoneCountry: "VN", packageName: "Gói A", amount: 1200, leadSource: "", leadChannel: "" },
      { childName: "Bé Hai", uid: "", phone: "", phoneCountry: "VN", packageName: "Gói B", amount: 800, leadSource: "", leadChannel: "" },
    ]);
  ...
  it("2 gói cùng 1 bé → 1 block 2 courses", () => {
    ...
    const payload = buildCreateActiveRequestPayload(pr, [
      { childName: "Bé Một", uid: "u1", phone: "", phoneCountry: "VN", packageName: "Gói A", amount: 1500, leadSource: "", leadChannel: "" },
      { childName: "Bé Một", uid: "u1", phone: "", phoneCountry: "VN", packageName: "Gói phụ", amount: 500, leadSource: "", leadChannel: "" },
    ]);
    expect(payload.uids).toHaveLength(1);
